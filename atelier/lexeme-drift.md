...
Filed under the `ouroboros-wobble` name and prima-clock stamp originally, alongside an unrelated concept ([`atelier/ouroboros-wobble.md`](./ouroboros-wobble.md) — the Nth-radian recursion/commission-creator idea) that had already claimed that anchor. Same coincidence of timing, two different ideas — moved here under its own name.
